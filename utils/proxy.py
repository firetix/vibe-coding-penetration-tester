...
class WebProxy:
    ...
    ) -> Tuple[Browser, BrowserContext, Page, Playwright]:
        """
            ...
            try:
                ...
                if (
                    ...
                    if "json" in content_type.lower():
                        ...
                        response_data["body"] = body_text[:5000] + (
                            "..." if len(body_text) > 5000 else ""
                        )
            except:
