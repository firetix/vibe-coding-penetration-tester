...
def _test_login_sqli(page: Page, form_selector: str, username_field: str, password_field: str, submit_button: str, max_tests: int = 3, timeout_per_test: int = 10000, **kwargs) -> Dict[str, Any]:
