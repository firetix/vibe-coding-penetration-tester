...
class TestXSSValidationIntegration:
    ...
    def test_xss_agent_and_validation(
        self, mock_config, llm_provider, scanner, mock_page
    ):
        ...
        with patch.object(
            ...
            validation_result = validation_agent.validate_finding(
                xss_result, mock_page, page_info
            )
    ...
    def test_full_xss_workflow(self, mock_config, llm_provider, scanner, mock_page):
        ...
        with patch.object(
            ...
            with patch.object(
                ...
                assert validation_result["validated"] == True
                assert (
                    "XSS detection" in validation_result["details"]["validation_method"]
                )
