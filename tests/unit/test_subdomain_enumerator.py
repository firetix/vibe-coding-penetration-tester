...
from utils.subdomain_enumerator import SubdomainEnumerator, enumerate_subdomains_enhanced
...
class TestSubdomainEnumerator:
    ...
    def test_verify_live_subdomains(self, mock_get):
        ...
        enumerator = SubdomainEnumerator("example.com")
        results = enumerator.verify_live_subdomains(["live.example.com", "dead.example.com"])
...
class TestNetworkUtilsIntegration:
    ...
    @patch('utils.subdomain_enumerator.enumerate_subdomains_enhanced')
    def test_network_utils_uses_enhanced(self, mock_enhanced):
        ...
        mock_enhanced.return_value = ["https://api.example.com"]
